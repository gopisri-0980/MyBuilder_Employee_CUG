...
import { ApproveBookingService } from './approve-booking.service';
...
@Component({
  ...
  styleUrls: ['./approve-booking.component.sass']
})
export class ApproveBookingComponent implements OnInit {
  ...
  main_div_controller: Array<any> = [];
  @ViewChild('content') content;


  pan_status_event: any;
  username_tabs: any;
  siteName_exits: Array<any> = [];
  validation_details: boolean;
  second_validation_details: boolean;
  third_validation_details: boolean;
  heading_dynamic : any;


  constructor(private service: ApproveBookingService, private cmn: CommonComponent, private http: Http, private formBuilder: FormBuilder,
    private route: ActivatedRoute , private router: Router, private modalService: NgbModal, private changeDetectorRef: ChangeDetectorRef, private sanitizer: DomSanitizer, public snackBar: MatSnackBar
  ) {
    ...
    this.route.queryParams.subscribe(params => {
      ...
      if(id == "Update Booking"){
        this.heading_dynamic = 'Update Booking';
      } else {
        this.heading_dynamic = "Approve booking";
      }
    ...
    console.log(sessionStorage.getItem("flatBookingId"))
  ...
  handler(event) {
    ...
    var from = document.getElementById('unit_booking_date');
    var to = document.getElementById('unit_Agreement_date');

    var fromDate = new Date($("#unit_booking_date").val()),
      minDate = [];
  ...
  ngOnInit() {
    ...
    $(function () {
      ...
      $('#first_country').change(function (e) {
        ...
        if (first_perment_countryid != "select") {
      ...
      $('#first_State').change(function (e) {
        ...
        if (first_perment_stateid != "select") {
      ...
      $('#first_country1').change(function (e) {
        ...
        if (first_perment_countryid1 != "select") {
      ...
      $('#first_State1').change(function (e) {
        ...
        if (first_perment_stateid1 != "select") {
      ...
      $('#second_Country').change(function (e) {
        ...
        if (second_perment_countryid != "select") {
      ...
      $('#second_State').change(function (e) {
        ...
        if (second_perment_stateid != "select") {
      ...
      $('#second_Country1').change(function (e) {
        ...
        if (second_perment_countryid1 != "select") {
      ...
      $('#second_State1').change(function (e) {
        ...
        if (second_perment_stateid1 != "select") {
      ...
      $('#Third_Country').change(function (e) {
        ...
        if (third_perment_countryid != "select") {
      ...
      $('#third_State').change(function (e) {
        ...
        if (third_perment_stateid != "select") {
      ...
      $('#Third_Country1').change(function (e) {
        ...
        if (third_perment_countryid1 != "select") {
      ...
      $('#third_State1').change(function (e) {
        ...
        if (third_perment_stateid1 != "select") {
  ...
  unit_discount_keyFunc(event) {
    ...
    if ($("#unit_amenitiesFlatCost").val() != "" && $("#unit_basic_flat_cost").val() != "" && $("#unit_AAA").val() != "" && $("#unit_discount").val() != "") {
      const aminitycost = parseFloat($("#unit_amenitiesFlatCost").val());
      const basicflatcost = parseFloat($("#unit_basic_flat_cost").val());
      const basic_discount = parseFloat($("#unit_discount").val());
      if ($("#unit_AAA").val() != "") {
      ...
      const total_discount = basicsum - parseFloat($("#unit_discount").val());
  ...
  search_function() {
    ...
    var body = {
      ...
      "flatBookingId": sessionStorage.getItem("flatBookingId"),
      "sessionKey": "" + sessionStorage.getItem("login_sessionkey"),
  ...
  public getBookingFormDetails() {
    $("#maindiv_hideme").show();
    bookingForData = "";
    bookingForData = JSON.parse(sessionStorage.getItem('approveCustData'));

    console.log(JSON.stringify(bookingForData));
    ...
    this.customer_Id = customerInfo.customerId;


    console.log(customerInfo);
    this.customerSchemeInfos = bookingForData.customerSchemeInfos;

    console.log(this.customerSchemeInfos);
    ...
    console.log(bookingForData.coApplicentDetails);
    ...
    if (bookingForData.coApplicentDetails.length == 0) {
      ...
      this.secondform_validation = false;
      this.thirdform_validation = false;
    ...
    if (bookingForData.coApplicentDetails.length == 2) {
      this.secondform_validation = true;
      this.thirdform_validation = true;
      this.hideme = true;
      $("#tab_second").show();
    ...
    //alert(JSON.stringify(unitDetails))
    ...
    this.flatbooking_Id = bookingForData.flatBookingInfo.BookingId;
    ...
    $("#Rate_per_sqft_unit").val(unitDetails.flatCost.perSqftCost);
    ...
    this.selected_projectid = unitDetails.siteInfo.siteId;
  ...
  ratepersqft_keyFunc(event) {
    ...
    $("#unit_quoted_base_price").val($("#Rate_per_sqft_unit").val());
    if ($("#sbua_unit").val() != "" && $("#Rate_per_sqft_unit").val() != "") {
      const num1 = parseFloat($("#sbua_unit").val());
      const num2 = parseFloat($("#Rate_per_sqft_unit").val());
      const sum = num1 * num2;
  ...
  Scheme_Name(siteids) {
    ...
    this.service.get_schemes_list(siteids).then(resp => {
      ...
      if (resp.responseCode == 200) {
        ...
        for (var i = 0; i < resp.responseObjList.length; i++) {
          $('#Scheme_name').append("<option value='" + resp.responseObjList[i].finSchemeName + "'>" + resp.responseObjList[i].finSchemeName + "</option>");
        }

        console.log(bookingForData.customerSchemeInfos[0].schemeName);
        ...
        if (bookingForData.customerSchemeInfos[0].schemeName == "Regular") {
          if (bookingForData.customerSchemeInfos[0].percentageValue != null && bookingForData.customerSchemeInfos[0].percentageValue != undefined && bookingForData.customerSchemeInfos[0].percentageValue != "") {
            $("#Scheme_name").val(bookingForData.customerSchemeInfos[0].schemeName);
          }
          $("#aaa_unit").hide();
        } else {
          $("#aaa_unit").show();
  ...
  get_oldsalesforesbg(selectedSiteID) {
    ...
    this.service.get_oldsalesforesbookingid(selectedSiteID).then(resp => {
      ...
      if (resp.responseCode == 200) {
        ...
        console.log(bookingForData.flatBookingInfo);
    ...
    this.service.getblock_details(projectid, blockid).then(resp => {
      ...
      if (resp.responseCode == 200) {
        ...
        if (unitDetails.flatInfo.floorDetId != null && unitDetails.flatInfo.floorDetId != "" && unitDetails.flatInfo.floorDetId != undefined) {
          ...
          unit_floorname_id = unitDetails.flatInfo.floorDetId;
          unit_floorname_name = unitDetails.flatInfo.floorName;
    ...
    this.service.getunit_details(projectid, blockid, floorDetId).then(resp => {
      ...
      if (resp.responseCode == 200) {
        ...
        if (unitDetails.flatInfo.flatId != null && unitDetails.flatInfo.flatId != "" && unitDetails.flatInfo.flatId != undefined) {
          ...
          this.flatId_Id = unitDetails.flatInfo.flatId;
  ...
  submitfun() {
    ...
    // if (this.passport_no_first == "") {
    //   swal("Please enter the first applicate passport number");
    //   return false;
    // }
    ...
    if (this.passport_no_first == undefined || this.passport_no_first == "" || this.passport_no_first == null) {
      this.passport_no_first = null;
    }
    ...
    if (first_perment_cityid == undefined || first_perment_cityid == "" || first_perment_cityid == null || first_perment_cityid == "select") {
      first_perment_cityid = null;
    }

    if (first_perment_city_name == undefined || first_perment_city_name == "" || first_perment_city_name == null || first_perment_city_name == "--Select--") {
      first_perment_city_name = null;
    }

    if (first_perment_stateid == undefined || first_perment_stateid == "" || first_perment_stateid == null || first_perment_stateid == "select") {
      first_perment_stateid = null;
    }

    if (first_perment_state_name == undefined || first_perment_state_name == "" || first_perment_state_name == null || first_perment_state_name == "--Select--") {
      first_perment_state_name = null;
    }

    if (first_perment_country_name == undefined || first_perment_country_name == "" || first_perment_country_name == null || first_perment_country_name == "--Select--") {
    ...
    if (first_perment_countryid == undefined || first_perment_countryid == "" || first_perment_countryid == null || first_perment_countryid == "select") {
    ...
    if (first_perment_cityid1 == undefined || first_perment_cityid1 == "" || first_perment_cityid1 == null || first_perment_cityid1 == "select") {
      first_perment_cityid1 = null;
    }

    if (first_perment_city_name1 == undefined || first_perment_city_name1 == "" || first_perment_city_name1 == null || first_perment_city_name1 == "--Select--") {
      first_perment_city_name1 = null;
    }

    if (first_perment_stateid1 == undefined || first_perment_stateid1 == "" || first_perment_stateid1 == null || first_perment_stateid1 == "select") {
      first_perment_stateid1 = null;
    }

    if (first_perment_state_name1 == undefined || first_perment_state_name1 == "" || first_perment_state_name1 == null || first_perment_state_name1 == "--Select--") {
      first_perment_state_name1 = null;
    }


    if (first_perment_country_name1 == undefined || first_perment_country_name1 == "" || first_perment_country_name1 == null || first_perment_country_name1 == "--Select--") {
    ...
    if (first_perment_countryid1 == undefined || first_perment_countryid1 == "" || first_perment_countryid1 == null || first_perment_countryid1 == "select") {
    ...
    if (this.secondform_validation == true) {
      ...
      // if (this.second_aadhaar_no == "") {
      //   swal("Please enter the second applicant aadhar number");
      //   return false;
      // }

      // if (this.passport_no_second == "") {
      //   swal("Please enter the second applicant passport number");
      //   return false;
      // }
      ...
      if (second_perment_cityid == undefined || second_perment_cityid == "" || second_perment_cityid == null || second_perment_cityid == "select") {
        second_perment_cityid = null;
      }

      if (second_perment_city_name == undefined || second_perment_city_name == "" || second_perment_city_name == null || second_perment_city_name == "--Select--") {
        second_perment_city_name = null;
      }

      if (second_perment_stateid == undefined || second_perment_stateid == "" || second_perment_stateid == null || second_perment_stateid == "select") {
        second_perment_stateid = null;
      }

      if (second_perment_state_name == undefined || second_perment_state_name == "" || second_perment_state_name == null || second_perment_state_name == "--Select--") {
        second_perment_state_name = null;
      }

      if (second_perment_countryid == undefined || second_perment_countryid == "" || second_perment_countryid == null || second_perment_countryid == "select") {
        second_perment_countryid = null;
      }


      if (second_perment_country_name == undefined || second_perment_country_name == "" || second_perment_country_name == null || second_perment_country_name == "--Select--") {
      ...
      if (second_perment_cityid1 == undefined || second_perment_cityid1 == "" || second_perment_cityid1 == null || second_perment_cityid1 == "select") {
        second_perment_cityid1 = null;
      }

      if (second_perment_city_name1 == undefined || second_perment_city_name1 == "" || second_perment_city_name1 == null || second_perment_city_name1 == "--Select--") {
        second_perment_city_name1 = null;
      }

      if (second_perment_stateid1 == undefined || second_perment_stateid1 == "" || second_perment_stateid1 == null || second_perment_stateid1 == "select") {
        second_perment_stateid1 = null;
      }

      if (second_perment_state_name1 == undefined || second_perment_state_name1 == "" || second_perment_state_name1 == null || second_perment_state_name1 == "--Select--") {
        second_perment_state_name1 = null;
      }


      if (second_perment_countryid1 == undefined || second_perment_countryid1 == "" || second_perment_countryid1 == null || second_perment_countryid1 == "select") {
        second_perment_countryid1 = null;
      }


      if (second_perment_country_name1 == undefined || second_perment_country_name1 == "" || second_perment_country_name1 == null || second_perment_country_name1 == "--Select--") {
    ...
    if (this.thirdform_validation == true) {
      ...
      // if (this.Third_aadhaar_no == "") {
      //   swal("Please enter the third applicant aadhar number");
      //   return false;
      // }

      // if (this.passport_no_third == "") {
      //   swal("Please enter the third applicant passport number");
      //   return false;
      // }
      ...
      if (third_perment_cityid == null || third_perment_cityid == undefined || third_perment_cityid == "" || third_perment_cityid == "undefined" || third_perment_cityid == "select") {
        third_perment_cityid = null;
      }

      if (third_perment_city_name == null || third_perment_city_name == undefined || third_perment_city_name == "" || third_perment_city_name == "undefined" || third_perment_city_name == "--Select--") {
        third_perment_city_name = null;
      }

      if (third_perment_stateid == null || third_perment_stateid == undefined || third_perment_stateid == "" || third_perment_stateid == "undefined" || third_perment_stateid == "select") {
        third_perment_stateid = null;
      }

      if (third_perment_state_name == null || third_perment_state_name == undefined || third_perment_state_name == "" || third_perment_state_name == "undefined" || third_perment_state_name == "--Select--") {
        third_perment_state_name = null;
      }

      if (third_perment_country_name == null || third_perment_country_name == undefined || third_perment_country_name == "" || third_perment_country_name == "undefined" || third_perment_country_name == "--Select--") {
        third_perment_country_name = null;
      }

      if (third_perment_countryid == null || third_perment_countryid == undefined || third_perment_countryid == "" || third_perment_countryid == "undefined" || third_perment_countryid == "select") {
        third_perment_countryid = null;
      }
      ...
      if (third_perment_cityid1 == null || third_perment_cityid1 == undefined || third_perment_cityid1 == "" || third_perment_cityid1 == "undefined" || third_perment_cityid1 == "select") {
        third_perment_cityid1 = null;
      }

      if (third_perment_city_name1 == null || third_perment_city_name1 == undefined || third_perment_city_name1 == "" || third_perment_city_name1 == "undefined" || third_perment_city_name1 == "--Select--") {
        third_perment_city_name1 = null;
      }

      if (third_perment_stateid1 == null || third_perment_stateid1 == undefined || third_perment_stateid1 == "" || third_perment_stateid1 == "undefined" || third_perment_stateid1 == "select") {
        third_perment_stateid1 = null;
      }

      if (third_perment_state_name1 == null || third_perment_state_name1 == undefined || third_perment_state_name1 == "" || third_perment_state_name1 == "undefined" || third_perment_state_name1 == "--Select--") {
        third_perment_state_name1 = null;
      }

      if (third_perment_country_name1 == null || third_perment_country_name1 == undefined || third_perment_country_name1 == "" || third_perment_country_name1 == "undefined" || third_perment_country_name1 == "--Select--") {
      ...
      if (third_perment_countryid1 == null || third_perment_countryid1 == undefined || third_perment_countryid1 == "" || third_perment_countryid1 == "undefined" || third_perment_countryid1 == "select") {
        third_perment_countryid1 = null;
      }
    ...
    //   swal("Please enter the amenities cost ");
    //   return false;
    // }
  ...
  DailogSubmit() {
    ...
    var body = {
      "sessionKey": "" + sessionStorage.getItem("login_sessionkey"),
      "siteId": this.selected_projectid,
  ...
  tabs_function_event(event) {

    console.log(event);
    console.log(this.pan_status_event);
    console.log(this.username_tabs);

    if (event == 'KYC DOCUMENTS (ALL APPLICANTS)') {
      $("#tab0").show();
      $("#tab1").hide();
      $("#tab2").hide();
      $("#tab3").hide();
    ...
    } else if (event == 'FIRST APPLICANT (MANDATORY)') {
      ...
      $("#tab4").hide();
      $("#tab5").hide();
    } else if (event == 'SECOND APPLICANT (MANDATORY)') {


      if (this.pan_status_event == "Entered Pan number already Exits." && this.username_tabs == "first_applicant") {

        swal(" Entered Pan number already exists please modify number in 1st applicant details");
        return false;
      ...
      } else if (this.pan_status_event == "Entered Pan number already Exits." && this.username_tabs == "second_applicant") {

        swal("Entered Pan number already exists please modify number in 2nd applicant details");
        return false;
      ...
      } else if (this.pan_status_event == "Entered Pan number already Exits." && this.username_tabs == "third_applicant") {

        swal("Entered Pan number already exists please modify number in 3rd applicant details");
        return false;
    ...
    } else if(event == 'PAYMENT SCHEDULE'){
  ...
  milestoneDetails() {
    ...
    var body = {
      ...
      "mileStoneAliasName": bookingForData.employeeFinancialRequest.mileStoneAliasName,
      "condition": "",
